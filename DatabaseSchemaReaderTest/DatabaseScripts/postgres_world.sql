...
--
-- Name: Martin; Type: TABLE; Schema: public; Owner: postgres; Tablespace: 
--

CREATE TABLE "Martin" (
    "MartinId" integer NOT NULL,
    "FirstName" character varying(45) NOT NULL,
    "LastName" character varying(45) NOT NULL
);


ALTER TABLE public."Martin" OWNER TO postgres;

--
-- Name: TABLE "Martin"; Type: COMMENT; Schema: public; Owner: postgres
--

COMMENT ON TABLE "Martin" IS 'My table';
...
--
-- Name: MartinPk; Type: CONSTRAINT; Schema: public; Owner: postgres; Tablespace: 
--

ALTER TABLE ONLY "Martin"
    ADD CONSTRAINT "MartinPk" PRIMARY KEY ("MartinId");
