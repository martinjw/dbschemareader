...
namespace DatabaseSchemaReaderTest.SqlGen.Migrations.UnitTests
{
    ...
    public class MigrationDropIndex
    {
        ...
        public void TestSqlServerWithSchema()
        {
            ...
            //assert
            Assert.IsTrue(sql.StartsWith("DROP INDEX IF EXISTS [UI_COUNTRY] ON [dbo].[Orders]", StringComparison.OrdinalIgnoreCase), "names should be quoted correctly");
        }
        ...
        public void TestSqlServerNoSchema()
        {
            ...
            //assert
            Assert.IsTrue(sql.StartsWith("DROP INDEX IF EXISTS [UI_COUNTRY] ON [Orders]", StringComparison.OrdinalIgnoreCase), "names should be quoted correctly");
        }
