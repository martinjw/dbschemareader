...
namespace DatabaseSchemaReaderFrameworkTests.ProviderSchemaReaders
{
    ...
    public class SqlAzureOrSqlServerSchemaReaderTests
    {
        ...
        /// </summary>
        [TestMethod, TestCategory("SqlAzure"), Ignore("Requires valid azure sql server connection string")]
