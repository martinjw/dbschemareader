namespace DatabaseSchemaReaderFrameworkTests
{
    ...
    static class ConnectionStrings
    {
        ...
        /// <summary>
        /// MySql connection string for sakila. NB: MySqlConnector = AllowUserVariables, Oracle MySql.Data = Allow User Variables (with spaces!)
        /// </summary>
        public static string MySql
        {
            get
            {
                return MySqlDevart + "AllowUserVariables=True;";
            }
        }
